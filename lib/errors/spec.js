...
var errorSpec = [{
  ...
  name: 'POCKETEER_IN_WALLET',
  message: 'Pocketeer in wallet.'
}, {
  name: 'WALLET_FULL',
  ...
  name: 'POCKETEER_VOTED',
  message: 'Pocketeer already voted on this transaction proposal.'
}, {
  name: 'NOT_AUTHORIZED',
  ...
  name: 'POCKETEER_REGISTERED',
  message: 'Pocketeer already register on server.'
}
];
